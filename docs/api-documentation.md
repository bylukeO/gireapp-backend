...
Welcome! This document outlines the available REST API endpoints for the GIREAPP Backend, providing details on request/response structures, validation, and crucial security expectations for frontend integration.
